...
<div class="navbar">
    ...
    <ul class="nav-links">
        <li><a href="post_vacancy.html">Add Hostel</a></li>
        <li><a href="remove_vacancy.html">Remove Hostel</a></li>
        <li><a href="landlord_logout.php">Logout</a></li>
        <li><button id="printButton" onclick="window.print()">Print</button></li>
        <li><a href="export_payments.php">Export Payments Records</a></li>
    </ul>
</div>
...
<div class="dashboard-container">
    ...
    <table>
        ...
        <?php } else { ?>
            <tr>
                <td colspan="8">No payments received yet.</td>
            </tr>
        <?php } ?>
    </table>
